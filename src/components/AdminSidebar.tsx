...
const items = [
  ...
  { title: "Add File", url: "/admin/add", icon: PlusCircle },
    ...
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 h-16 flex items-center justify-between px-4 z-40 bg-sidebar/80 backdrop-blur-xl border-b border-border">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-primary/20 border border-primary/30 grid place-items-center glow">
      ...
      <aside className={cn(
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-border">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-primary/20 border border-primary/30 grid place-items-center">
              <Zap className="w-4 h-4 text-primary" />
            </div>
            <div className="font-semibold text-sm text-white">Admin Console</div>
          </div>
      ...
      <aside className="hidden md:flex sticky top-0 h-screen w-64 flex-col border-r border-border bg-sidebar/80 backdrop-blur-xl">
        <div className="flex items-center gap-2 px-6 py-5 border-b border-border">
          <div className="w-9 h-9 rounded-xl bg-primary/20 border border-primary/30 grid place-items-center glow">
            <Zap className="w-5 h-5 text-primary" strokeWidth={2.5} />
          </div>
          <div className="leading-tight">
            <div className="font-semibold text-sidebar-foreground">DriveLink</div>
            <div className="text-xs text-primary font-bold uppercase tracking-widest mt-0.5">Admin Console</div>
          </div>
        </div>
