  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10 max-w-5xl mx-auto">
      <header className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Generate download links</h1>
      ...
      <div className="glass-card rounded-2xl p-4 sm:p-6">
        <textarea
          ...
          rows={8}
          className="w-full font-mono text-sm bg-background/50 border border-border rounded-md p-3 focus:outline-none focus:ring-1 focus:ring-primary resize-y min-h-[180px]"
        />
        <div className="mt-4 flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={loading}
              className="gradient-primary text-primary-foreground border-0 glow flex-1 sm:flex-none"
              size="lg"
            >
              {loading ? (
